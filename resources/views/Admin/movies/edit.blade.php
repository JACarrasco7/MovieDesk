...
<div class="content-wrapper">
    ...
    <section class="content d-flex align-items-center">
        <!-- Default box -->
        <div class="card w-75" style="margin: 0 auto;margin-top:75px">
            <div class="card-body">
                <form action="{{ url('/admin/movies/'.$movie->id.'/edit') }}" method="post"
                            ...
                            <div class="col-8">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group mb-2 mr-sm-2">
                                                    ...
                                                    <input type="text" class="form-control" id="title" name="title"
                                                        placeholder="Titulo" value="{{ $movie->title }}">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <textarea class="form-control" name="synopsis" rows="3"
                                                placeholder="Introduce sinopsis de la pelicula">{{ $movie->synopsis }}</textarea>
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-6 text-center">
                                        <img src="{{ $movie->URLCover }}" class="img-thumbnail previsualizar"
                                            width="25%">
                                    </div>
                                </div>
                            </div>
